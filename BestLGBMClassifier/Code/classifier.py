...
train_data = pd.read_csv('./BestLGBMClassifier/raw_data/nw_train_public.csv')
submit_example = pd.read_csv('./BestLGBMClassifier/raw_data/submit_example.csv')
test_public = pd.read_csv('./BestLGBMClassifier/raw_data/test_public.csv')
train_inte = pd.read_csv('./BestLGBMClassifier/raw_data/train_internet.csv')
